...
ALTER TABLE IF EXISTS ONLY public.components_page_section_aboutuses DROP CONSTRAINT IF EXISTS components_page_section_aboutuses_pkey CASCADE;
...
ALTER TABLE IF EXISTS ONLY public.authors DROP CONSTRAINT IF EXISTS authors_pkey CASCADE;
...
COPY public.authors_components (id, field, "order", component_type, component_id, author_id, entity_id) FROM stdin;
8	socialLinks	1	components_page_social_links	8	4	4
9	socialLinks	2	components_page_social_links	9	4	4
10	socialLinks	1	components_page_social_links	10	5	5
11	socialLinks	2	components_page_social_links	11	5	5
15	socialLinks	1	components_page_social_links	15	7	7
16	socialLinks	2	components_page_social_links	16	7	7
17	socialLinks	3	components_page_social_links	17	7	7
\.
